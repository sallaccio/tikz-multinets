...
As shown in the example above, this is done by attaching to the \emph{name} of the cell a suffix \verb|.pal 3| for the third principal port or \verb|.pax 1| for the first auxiliary one.
